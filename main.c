...
int main(int argc, char ** argv)
{
    ...
    lv_disp_buf_init(&disp_buf, buf, buf, DISP_BUF_SIZE);
...
static void hal_init(void)
{
    ...
    static lv_color_t buf1_1[LV_VER_RES_MAX*LV_HOR_RES_MAX];
    lv_disp_buf_init(&disp_buf1, buf1_1, NULL, LV_VER_RES_MAX*LV_HOR_RES_MAX);
